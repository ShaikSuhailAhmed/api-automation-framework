...
public class UserServiceNegative {
    ...
    @Parameters({"type1", "severity", "testDescription", "name", "owner", "email", "phonenumber",
    ...
    public void CreateFranchise(String type1, String severity, String testDescription,
    ...
    @Parameters({"type1", "severity", "testDescription", "name", "email", "phonenumber",
            ...
            "state", "country", "expectedStatusCodeStr"})
    public void UpdateFranchise( String type1, String severity, String testDescription,
    ...
    @Parameters({"sno", "type1", "severity", "testDescription", "pageSize", "country", "status", "expectedStatusCodeStr"})

    public void GetFranchiseList(String type1, String severity, String testDescription,
